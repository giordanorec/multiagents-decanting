...
def main():
    ...
    block = (
        ...
        "GUARDIÃO DA CONSTITUIÇÃO (docs/CONSTITUICAO.md) — Art. 1: código e docs andam\n"
        "JUNTOS. Ao construir, a spec vira as-built e os docs vivos afetados são\n"
        "atualizados NO MESMO ciclo; a spec nunca envelhece. Uma feature NÃO fecha sem\n"
        "reports/feature-<NNN>/docs-sync.md (spec as-built + docs vivos + decisão real)\n"
        "— o hook bloqueia. Qualquer pessoa/IA externa deve entender o projeto só pelos\n"
        "documentos, além da codebase.\n\n"
